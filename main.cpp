...
CSTR(wrapper,var x = 3,
                    ...
                    if (45 > y) {
                      ...
                      tstruct.b = x
                          ...
                          return ret
                          ,var iterator = users, interator.advance(), var b1
= 89.endorse(words).otherOp(more,words), var b2 = 4894.ensure(otherwords), b2 =
2341, var b3 = *b2.field.more.field->field.isValid(), if (true || false) {return
b1} else {return b2}, while (iterator.isValid()) {iterator = iterator->next},
return b1); //*/
