...
int main() {
  CSTR(wrapper,var iterator = users, var b1 = 89, var b2 = 4894, b2 = 2341, var b3 = *b2.field.more.field->field.isValid(), if (true || false) {return b1} else {return b2}, while (iterator.isValid()) {iterator = iterator->next}, return b1);
  parse<wrapper> p;
