<?php
    ...
    new Expression('Operation',new Field('name',$String_t),new Field('Hndl',$Expression_t),
                    new Field('expr_args',$Argument_pack_t), new Field('var_args',$Argument_pack_t)),
    new Statement('Operation',new Field('name',$String_t),new Field('Hndl',$Expression_t),
                    new Field('expr_args',$Argument_pack_t), new Field('var_args',$Argument_pack_t)),
